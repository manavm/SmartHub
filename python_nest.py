...
if __name__ == "__main__":
    if (len(sys.argv) >= 2):
	    ...
	    print "The Nest thermostat is set to " + str(nest.target)
    	elif sys.argv[1] == "set":
            nest.set_target(sys.argv[2])
            print "The current temperature is " + str(nest.temperature)
	    print "The target temperature is now " + str(nest.target)
    else:
	print "Please include get or set"
